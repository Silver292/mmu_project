...
% balance references (https://tex.stackexchange.com/questions/184419/latex-with-biblatex-and-biber-how-to-balance-printbibliography-in-a-two-column)
\renewbibmacro{finentry}{%
  \iffieldequalstr{entrykey}{bellavista_towards_2016}%<- key after which you want the break
   {\finentry\newpage}
   {\finentry}}
